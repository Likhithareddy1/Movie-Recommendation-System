...
data <- read_csv("C:/Users/Tazz/Downloads/data_cleaned.csv", show_col_types = FALSE)
...
server <- function(input, output, session) {
  ...
  input_movies <- read_csv("C:/Users/Tazz/Downloads/formatted_movies.csv")
  ...
  write_csv(final_output, "C:/Users/Tazz/Downloads/recommendations_output.csv")
  ...
  # Step 13: Compute Scores for Actual vs Predicted
  observe({
    predicted_movies <- read_csv("C:/Users/Tazz/Downloads/recommendations_output.csv", col_names = c("predicted_movies"))
    actual_movies <- read_csv("C:/Users/Tazz/Downloads/y_data_comma_separated_corrected.csv", col_names = c("actual_movies"))
    input_movies <- read_csv("C:/Users/Tazz/Downloads/cleaned_movies.csv", col_names = c("input_movies"))
    ...
    write_csv(result_df, "C:/Users/Tazz/Downloads/score_file.csv")
